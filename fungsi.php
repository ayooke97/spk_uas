<?php
    ...
    $queryalternatif = mysqli_query($koneksi,"SELECT * FROM talternatif ORDER BY id_alternatif");
    $i=0;
    ...
    $querykriteria = mysqli_query($koneksi,"SELECT * FROM tkriteria ORDER BY id_kriteria");
    $i=0;
    ...
    while ($dataalternatif = mysqli_fetch_array($queryalternatif))
    {
        ...
        while ($datakriteria = mysqli_fetch_array($querykriteria))
        {
            $queryalternatifkriteria = mysqli_query($koneksi,"SELECT * FROM talternatif_kriteria WHERE id_alternatif = '$dataalternatif[id_alternatif]' AND id_kriteria = '$datakriteria[id_kriteria]'");
